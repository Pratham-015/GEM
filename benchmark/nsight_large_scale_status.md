...
- Predicated-on threads per instruction: `75.58%`
- DRAM peak utilization: `0.00%`
- DRAM bandwidth: `3.03 MB/s`
- Global load/store sectors per request: `7.52` / `3.70`
- Profiled kernel duration: `308.035 ms`
...
Raw counters: [benchmark/nsight_large_scale.csv](nsight_large_scale.csv)
