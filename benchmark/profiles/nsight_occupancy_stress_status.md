...
- Launch: `16` blocks x `256` threads, `0.40` waves/SM
- Resources: `124` registers/thread, `16640` shared bytes/block
- Uniform branch targets: `98.69%`
- Derived divergent branch targets: `1.31%`
- Predicated-on threads per instruction: `83.23%`
- DRAM peak utilization: `0.01%`
- DRAM bandwidth: `15.34 MB/s`
- Global load/store sectors per request: `9.72` / `4.06`
- Profiled kernel duration: `97.657 ms`
...
Raw counters: [benchmark/profiles/nsight_occupancy_stress.csv](nsight_occupancy_stress.csv)
